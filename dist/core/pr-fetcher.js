import { MAX_DIFF_BYTES } from './types.js';
...
export async function fetchPR(octokit, config) {
...
export async function fetchExistingItems(octokit, config) {
...
export async function fetchVisionDocument(octokit, config) {
    const { owner, repo } = config;
